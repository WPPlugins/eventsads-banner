<?php
include_once 'class-beb-events-ads-banner-op-com.php';
...
class Beb_Events_Ads_Banner_View extends Beb_Events_Ads_Banner_Op_Com {
    ...
    private function banner_footer () {
        ...
        BEBCVBANNER_VERSION_JS_VIEW);
        wp_enqueue_script (parent::$prefisso_nome.'-view.js', false, array(), BEBCVBANNER_VERSION_JS_VIEW);
    }
    final public function beb_eab_view_recupera_banner () {
        if (!self::$init_banner and !$this->is_admin and !wp_is_mobile()) {
