<?php
if (!include_once 'class-beb-events-ads-banner-op-com.php') {
    exit('<h1>ERRORE - cod. Adm-01 - File richiesto inesistente</h1>');
}
...
class Beb_Events_Ads_Banner_Adm extends Beb_Events_Ads_Banner_Op_Com {
    ...
    private static $nome_form_add_tmp = 'fmt_eab_banner_new';
    private static $nome_form_settings_tmp = 'beb_eab_banner_settings';
    private static $nome_form_issues_tmp = 'beb_eab_banner_issues';
    ...
    final public function __construct($aggiorna_stato = NULL) {
        ...
        if (!has_action('beb_eab_adm_add')) {
            ...
            add_action( 'admin_init', array($this, 'beb_eab_adm_problemi'));
	...
	private function carica_menu () {
	    ...
	    $this->hook_pag_settings = add_submenu_page(
    	    ...
    	    'administrator',
    	    parent::$elenco_pagine['pagina_settings'],
    	    array($this, 'beb_eab_adm_settings_contenuto')
	    );
	    $this->hook_pag_issues = add_submenu_page(
    		parent::$elenco_pagine['pagina_preview'],
    		__("Issues partial solved", parent::$prefisso_nome),
    		__("Banner Issues", parent::$prefisso_nome),
    		'administrator',
    		parent::$elenco_pagine['pagina_problemi'],
    		array($this, 'beb_eab_adm_problemi_contenuto')
	    );
	}
	...
	public function beb_eab_adm_carica_stile_script ($hook) {
	    ...
	    $hook_pagine [] = $this->hook_pag_issues;
	    ...
	    if ($hook === $this->hook_pag_add) {
	        ...
	        wp_enqueue_script(parent::$prefisso_nome.'-adm.js', false, array(), BEBCVBANNER_VERSION_JS_ADM);
	        wp_enqueue_script(parent::$prefisso_nome.'-adm-set.js', false, array(), BEBCVBANNER_VERSION_JS_ADM_SET);
	    } elseif ($hook === $this->hook_pag_issues) {
	        $custom_css .= 'top: 40px;';
	        wp_enqueue_script(parent::$prefisso_nome.'-adm.js', false, array(), BEBCVBANNER_VERSION_JS_ADM);
	    }
	    $custom_css .= ' }';
	...
	public function beb_eab_adm_riassunto_contenuto () {
        ...
        <style type="text/css">
    	    #beb-eab-banner-riass-form .eab-interruttore-banner:HOVER {
	    ...
	    <?php if ('wpml' === $this->plugin_per_traduzioni and !function_exists('icl_register_string')): ?>
			<div class="beb-eab-contenitore-admin beb-eab-preview" style="border-color: #ff0000;">
    	        <h1 style="color: #ff0000; line-height: 100%; margin: 0;">
    	        	<?php echo __('You have installed WPML, to run the banner in multilingual mode you need to install "String-Translation"', parent::$prefisso_nome); ?>
    	       	</h1>
    	    </div>
		<?php endif; ?>
	    <?php if (isset($this->contenuto[0]['banner_esempio'])): ?>
	       <h1 class="beb-eab-riass-add">
               <a href="<?php echo site_url();?>/wp-admin/admin.php?page=<?php echo parent::$elenco_pagine['pagina_add']; ?>"><?php echo __("Create first banner", parent::$prefisso_nome); ?></a>
           </h1>
	    <?php endif; ?>
	    <div class="beb-eab-contenitore-admin beb-eab-preview" style="min-height: 250px;">
            <?php
                $n_contenuti = count($contenuto);
                for ($i = 0; $i < $n_contenuti; $i++): ?>
                <h1><?php echo __("Event Name: ", parent::$prefisso_nome).' <i>"'.$contenuto[$i]['nome_evento'].'"</i>'; ?></h1>
                <div style="padding: 0; border: none;">
                    <?php //if (!isset($contenuto[$i]['banner_esempio'])) :?>
                        ...
                        <?php settings_fields(self::$nome_form_prev_tmp.'_gr'); ?>
                            <div class="fmt-eab-riga" style="width: 100%">
                                <div class="fmt-eab-riga-sx">
                                    <div class="eab-interruttore-banner" style="background: url('<?php echo BEBCVBANNER__PLUGIN_URL.'img/'.
                                ...
                                <div class="fmt-eab-riga-dx" style="float: right; margin-top: 10px;">
                            ...
                            <div class="fmt-eab-riga">&nbsp;
                                <div class="fmt-eab-riga-sx">
                                    <div class="beb-eab-proprieta-banner">
                                        <p>
                                ...
                                <div class="fmt-eab-riga-dx" style="float: right;">
	    ...
	    <?php
		/*
	    echo '<div class="beb-eab-contenitore-admin" style="min-height: 190px;">';
    	    //print_r($this->hook_pagine);
    	    echo '<br><br><br>';
    	    //echo $contenuto[0]['descrizione'];
	...
	public function beb_eab_adm_add_contenuto ($contenuto=NULL) {
	    ...
	    <div class="beb-eab-contenitore-admin beb-eab-imp-add">
            <h1><?php echo $contenuto[0]['titolo_pagina']; ?></h1>
            <h4><?php echo $contenuto[0]['sottotitolo_pagina']; ?></h4>

	       <form method="post" action="options.php">
	           <?php settings_fields($nome_arr_form.'_gr'); ?>
	           <!-- <fieldset class="contenitore-input beb-eab-add-options-el"> -->
               <fieldset>
                    <legend><?php echo __("Options", parent::$prefisso_nome); ?></legend>
                    <div class="fmt-eab-riga">
                        <div class="fmt-eab-riga-sx">
                            <div class="eab-interruttore-banner"
                                    style="background: url('<?php echo BEBCVBANNER__PLUGIN_URL.'img/'. $contenuto[0]['stato_banner'].'.png'; ?>') no-repeat scroll 0 0 rgba(0, 0, 0, 0);">
                                <input type="hidden" name="<?php echo $nome_arr_form; ?>[stato_banner]" value="<?php echo $contenuto[0]['stato_banner']; ?>" />
                                &nbsp;
                            </div>
                        </div>
                        <div class="fmt-eab-riga-c">
                            <strong class="beb-eab-add-banner-sugg" style="margin: 0; text-align: left;">
                                <?php echo __("Banner ID Name", parent::$prefisso_nome); ?><span style="color: #ff0000;">*</span> :
                            </strong>
                            <br />
                            <input type="text" id="beb-eab-nome-evento" name="<?php echo $nome_arr_form; ?>[nome_evento]" <?php echo $contenuto[0]['nome_evento']; ?> />
                        </div>
                        <div class="fmt-eab-riga-dx eccezione1">
                            <span class="beb-eab-add-banner-sugg">
                                (<strong style="color: #ff0000;"><?php echo __("Required - Unique Key ID", parent::$prefisso_nome) ?></strong><?php echo __(" - Max ", parent::$prefisso_nome) ?>
                                    <span class="beb-eab-add-banner-numeri">40</span> <?php echo __(" characters)", parent::$prefisso_nome); ?>
                            </span>
                        </div>
                    </div>
                    <div class="fmt-eab-riga">
                        ...
                        <div class="fmt-eab-riga-dx">
                            <div>
                                <input type="radio" name="<?php echo $nome_arr_form; ?>[open]" value="home"
                                    <?php if ($contenuto[0]['open'] === 'home') {echo 'checked="checked"'; }?>>
                                <?php echo __("Open only in Home Page", parent::$prefisso_nome); ?>&nbsp;&nbsp;&nbsp;
                            </div>
                            <div>
                                <input type="radio" name="<?php echo $nome_arr_form; ?>[open]" value="all"
                                    <?php if ($contenuto[0]['open'] === 'all') {echo 'checked="checked"'; }?>>
                    	        <?php echo __("Open in all site", parent::$prefisso_nome); ?>&nbsp;&nbsp;&nbsp;
                            </div>
                            <div>
                                <input type="radio" name="<?php echo $nome_arr_form; ?>[open]" value="never"
                                    <?php if ($contenuto[0]['open'] === 'never') {echo 'checked="checked"'; }?>>
                    	        <?php echo __("Never open", parent::$prefisso_nome); ?>
                            </div>
                        </div>
               ...
               <fieldset>
                    ...
                    <div class="fmt-eab-riga">
                        <div class="fmt-eab-riga-sx" style="max-width: 50%; min-width: 185px;">
                            ...
                            <select name="<?php echo $nome_arr_form; ?>[data_evento_giorno]" id="beb-eab-giorno">
                                <?php
                                if (isset($contenuto[0]['data_evento_giorno']) and !empty($contenuto[0]['data_evento_giorno'])){
                                    if ($contenuto[0]['data_evento_giorno'] < 10) {
                                        $num_giorno = '0'.$contenuto[0]['data_evento_giorno'];
                                    } else {
                                        $num_giorno = $contenuto[0]['data_evento_giorno'];
                                    }
                                } ?>
                                <option selected="selected" <?php if (isset($num_giorno)){ echo 'value="'.$num_giorno.'"'; }?>>
                                	<?php if (isset($num_giorno)){ echo $num_giorno; }?>
                                </option>
                                <?php
                                for ($i = 1; $i <= 31; $i++) {
                                   if ($i < 10) {
                            ...
                            <select name="<?php echo $nome_arr_form; ?>[data_evento_mese]" id="beb-eab-mese">
                                <?php
                                if (isset($contenuto[0]['data_evento_mese']) and !empty($contenuto[0]['data_evento_mese'])){
                                    if ($contenuto[0]['data_evento_mese'] < 10) {
                                        $num_mese = '0'.$contenuto[0]['data_evento_mese'];
                                    } else {
                                        $num_mese = $contenuto[0]['data_evento_mese'];
                                    }
                                    $nome_mese = array_search($num_mese, $this->mappa_mese_numero);
                                } ?>
                                <option selected="selected" <?php if (isset($num_mese)){ echo 'value="'.$num_mese.'"'; }?>>
                                	<?php if (isset($num_mese)){ echo $num_mese; }?>
                                </option>
                        ...
                        <div class="fmt-eab-riga-dx eccezione3">
                            <span class="beb-eab-add-banner-sugg eccezione2">
                    ...
                    <div class="fmt-eab-riga">
                        <div class="fmt-eab-riga-sx" style="max-width: 50%; min-width: 185px;">
                            ...
                            <input type="text" id="beb-eab-titolo" name="<?php echo $nome_arr_form; ?>[titolo]" <?php echo $contenuto[0]['titolo']; ?>
                                class="fmt-banner-testi" />
                            <p class="beb-eab-add-banner-sugg">
                    	       <?php echo '(<strong style="color: #ff0000;">'.__("Required</strong> - Max ", parent::$prefisso_nome).
                        	    ' <span class="beb-eab-add-banner-numeri">25</span> '.__(" characters)", parent::$prefisso_nome); ?>
                    	    </p>
                        </div>
                        <div class="fmt-eab-riga-dx" style="max-width: 50%; min-width: 250px;">
                            ...
                            <input type="text" id="beb-eab-sottotitolo" name="<?php echo $nome_arr_form; ?>[sottotitolo]" <?php echo $contenuto[0]['sottotitolo']; ?>
                                style="width: 250px;" class="fmt-banner-testi" />
                            <p class="beb-eab-add-banner-sugg">
                    	       <?php echo __("(<strong>Optional</strong> - Max ", parent::$prefisso_nome).' <span class="beb-eab-add-banner-numeri">34</span> '.__(" characters)", parent::$prefisso_nome); ?>
                    	    </p>
                        </div>
                    </div>
                    <div class="fmt-eab-riga">
                        ...
                        <textarea id="beb-eab-descrizione" name="<?php echo $nome_arr_form; ?>[descrizione]" <?php if(empty($contenuto[0]['descrizione'])){
                            echo 'placeholder="'.__("Enter the Event's description here", parent::$prefisso_nome).'"';}?> class="fmt-banner-testi"><?php
                        ...
                        <p class="beb-eab-add-banner-sugg"><?php echo __("(<strong>Optional</strong> - Max ", parent::$prefisso_nome); ?>
        	               <span class="beb-eab-add-banner-numeri">200</span> <?php echo __(" characters)", parent::$prefisso_nome); ?>
        	            </p>
    	            </div>
               </fieldset>
            	    ...
            	    <div class="fmt-eab-riga">
                        ...
                        <div class="fmt-eab-riga-c">
                           <input type="text" id="beb-eab-link-sx-titolo" name="<?php echo $nome_arr_form; ?>[link_sx_titolo]" <?php echo $contenuto[0]['link_sx_titolo'];?>
                                class="fmt-banner-testi" />
                           <p class="beb-eab-add-banner-sugg eccezione2">
                                <?php echo __("(<strong>Optional</strong> - Max ", parent::$prefisso_nome)?>
                                <span class="beb-eab-add-banner-numeri">20</span> <?php echo __(" characters)", parent::$prefisso_nome); ?>
                            </p>
                        </div>
            	    </div>
            	    <div class="fmt-eab-riga nascondi-riga">
            	       <div class="fmt-eab-riga-sx">
            	       ...
            	       <div class="fmt-eab-riga-dx">
            	           <span class="beb-eab-add-banner-sugg eccezione2">
            	               <?php echo __("(<strong>Optional</strong>)", parent::$prefisso_nome); ?>
            	           </span>
            	       </div>
            	    </div>
            	    <div class="fmt-eab-riga">
            	       <div class="fmt-eab-riga-sx">
            	           <strong><?php echo __("Right link Title", parent::$prefisso_nome); ?>:</strong>
            	       </div>
            	       <div class="fmt-eab-riga-c">
                ...
                <fieldset>
                    ...
                    style="width: 100%;" />
                    <p class="beb-eab-add-banner-sugg">(<strong><?php echo __("Optional - Max Height 120px", parent::$prefisso_nome); ?></strong>)</p>
        ...
        <div class="beb-eab-contenitore-admin beb-eab-imp-add vPRO">
            <a href="#" style="text-decoration: none;">
                <h1 style="color: #0000ff; text-align: center;"><?php echo __("Pro Version", parent::$prefisso_nome); ?></h1>
                <h2><?php echo __("In the Pro Version is possible to enable this feature and create multiple banners", parent::$prefisso_nome); ?></h2>
                <div class="fmt-eab-riga">
                    <div class="fmt-eab-riga-sx">
                        <?php echo __("Video:", parent::$prefisso_nome); ?>
                    </div>
                    <div class="fmt-eab-riga-c">
                        <i><?php echo __("Drop here", parent::$prefisso_nome); ?></i>
                    </div>
                    <div class="fmt-eab-riga-dx">
                        <?php echo __("(<strong>Optional</strong> - Insert a video)", parent::$prefisso_nome); ?>
                    </div>
                </div>
                <div class="fmt-eab-riga">
                    <div class="fmt-eab-riga-sx">
                        <?php echo __("Display it on the:", parent::$prefisso_nome); ?>
                    </div>
                    <div class="fmt-eab-riga-c">
                        <?php echo date('Y / m / d'); ?>
                    </div>
                    <div class="fmt-eab-riga-dx">
                        <?php echo __("(<strong>Optional</strong> - When publishing the Banner)", parent::$prefisso_nome); ?>
                    </div>
                </div>
                <div class="fmt-eab-riga">
                    <div class="fmt-eab-riga-sx">
                        <?php echo __("Remove it on the:", parent::$prefisso_nome); ?>
                    </div>
                    <div class="fmt-eab-riga-c">
                        <?php echo date('Y / m / d'); ?>
                    </div>
                    <div class="fmt-eab-riga-dx">
                        <?php echo __("(<strong>Optional</strong> - When remove the Banner)", parent::$prefisso_nome); ?>
                    </div>
                </div>
                <div class="fmt-eab-riga">
                    <div class="fmt-eab-riga-sx">
                        <?php echo __("Refresh:", parent::$prefisso_nome); ?>
                    </div>
                    <div class="fmt-eab-riga-c">
                        300
                    </div>
                    <div class="fmt-eab-riga-dx">
                        <?php echo __("(Banner refreshing Time  - in seconds)", parent::$prefisso_nome); ?>
                    </div>
                </div>
            </a>
        </div>
	...
	public function beb_eab_adm_settings_contenuto () {
        ...
        <div class="beb-eab-contenitore-admin indice">
            <h1><?php echo __("Index", parent::$prefisso_nome); ?></h1>
            <ol>
                ...
                <li><span class="beb-eab-banner-indice" title="beb-eab-imp-reset"><?php echo __("Reset all settings", parent::$prefisso_nome); ?></span></li>
                <li class="beb-eab-banner-indice-pro">
                    <span><?php echo __("Shape and position of the banner", parent::$prefisso_nome); ?></span>
                </li>
            </ol>
        </div>
        <form method="post" action="options.php">
            <div class="beb-eab-contenitore-admin beb-eab-imp-colori">
                <?php settings_fields($nome_arr_form.'_gr'); ?>
                ...
                <div class="fmt-eab-riga">
                    <div class="fmt-eab-riga-sx">
                        <?php echo __("Date color (day):", parent::$prefisso_nome); ?>
                    </div>
                    <div class="fmt-eab-riga-dx">
                        #<input type="text" value="<?php echo $this->impostazioni['#beb-eab-banner-data h1']['color']; ?>" alt="beb-eab-banner-data h1"
                ...
                <div class="fmt-eab-riga">
                    <div class="fmt-eab-riga-sx">
                        <?php echo __("Date color (month):", parent::$prefisso_nome); ?>
                    </div>
                    <div class="fmt-eab-riga-dx">
                        #<input type="text" value="<?php echo $this->impostazioni['#beb-eab-banner-data h2']['color']; ?>" alt="beb-eab-banner-data h2"
                            name="<?php echo $nome_arr_form; ?>[#beb-eab-banner-data h2][color]" class="my-color-field" />
                        <div class="beb-eab-add-banner-colore" style="background-color: #<?php echo $this->impostazioni['#beb-eab-banner-data h2']['color']; ?>;"></div>
                    </div>
                </div>
                <div class="fmt-eab-riga">
                    <div class="fmt-eab-riga-sx">
                ...
                <div class="fmt-eab-riga">
                    ...
                    <div class="fmt-eab-riga-dx">
                        #<input type="text" value="<?php echo $this->impostazioni['#beb-eab-banner-cont-prenota-sx, #beb-eab-banner-cont-prenota-sx a']['color']; ?>" alt="beb-eab-banner-cont-prenota-sx a"
                            name="<?php echo $nome_arr_form; ?>[#beb-eab-banner-cont-prenota-sx, #beb-eab-banner-cont-prenota-sx a][color]" />
                        <div class="beb-eab-add-banner-colore" style="background-color: #<?php echo $this->impostazioni['#beb-eab-banner-cont-prenota-sx, #beb-eab-banner-cont-prenota-sx a']['color']; ?>;"></div>
                    </div>
                </div>
                <div class="fmt-eab-riga">
                    <div class="fmt-eab-riga-sx">
                    ...
                    <div class="fmt-eab-riga-dx">
                        #<input type="text" value="<?php echo $this->impostazioni['#beb-eab-banner-cont-prenota-dx, #beb-eab-banner-cont-prenota-dx a']['color']; ?>" alt="beb-eab-banner-cont-prenota-dx a"
                            name="<?php echo $nome_arr_form; ?>[#beb-eab-banner-cont-prenota-dx, #beb-eab-banner-cont-prenota-dx a][color]" />
                        <div class="beb-eab-add-banner-colore" style="background-color: #<?php echo $this->impostazioni['#beb-eab-banner-cont-prenota-dx, #beb-eab-banner-cont-prenota-dx a']['color']; ?>;"></div>
                    </div>
                </div>
                <div class="fmt-eab-riga">
                    <div class="fmt-eab-riga">
                    ...
                    <div class="fmt-eab-riga colore2">
                        <div class="fmt-eab-riga-sx">
            ...
            <div class="beb-eab-contenitore-admin beb-eab-imp-formattazione">
                <?php settings_fields($nome_arr_form.'_gr'); ?>
                <h1 style="margin-bottom: 50px;"><?php echo __("Formatting Text and Paragraph", parent::$prefisso_nome); ?></h1>
                <div class="fmt-eab-riga">
                    <p><?php echo __("Event Date - Day: ", parent::$prefisso_nome); ?></p>
                    <div class="fmt-eab-riga-sx">
                        <input type="text" value="<?php echo $this->impostazioni['#beb-eab-banner-data h1']['font-size']; ?>"
                            alt="beb-eab-banner-data-giorno-size" name="<?php echo $nome_arr_form; ?>[#beb-eab-banner-data h1][font-size]" />
                    </div>
                    <div class="fmt-eab-riga-dx">
                        ...
                        <?php echo __("left", parent::$prefisso_nome); ?><br />
                        ...
                        <?php echo __("center", parent::$prefisso_nome); ?><br />
                ...
                <div class="fmt-eab-riga">
                    <p><?php echo __("Event Date - Month: ", parent::$prefisso_nome); ?></p>
                    <div class="fmt-eab-riga-sx">
                ...
                <div class="fmt-eab-riga">
                    <p><?php echo __("Title:", parent::$prefisso_nome); ?></p>
                    <div class="fmt-eab-riga-sx">
                        <input type="text" value="<?php echo $this->impostazioni['#beb-eab-banner-testo h1']['font-size']; ?>"
                            alt="beb-eab-banner-titolo-size" name="<?php echo $nome_arr_form; ?>[#beb-eab-banner-testo h1][font-size]" />
                    </div>
                    <div class="fmt-eab-riga-dx">
                ...
                <div class="fmt-eab-riga">
                    <p><?php echo __("Subtitle:", parent::$prefisso_nome); ?></p>
                    <div class="fmt-eab-riga-sx">
                        <input type="text" value="<?php echo $this->impostazioni['#beb-eab-banner-testo h2']['font-size']; ?>"
                            alt="beb-eab-banner-sottotitolo-size" name="<?php echo $nome_arr_form; ?>[#beb-eab-banner-testo h2][font-size]" />
                    </div>
                    <div class="fmt-eab-riga-dx">
                ...
                <div class="fmt-eab-riga">
                    <p><?php echo __("Description:", parent::$prefisso_nome); ?></p>
                    <div class="fmt-eab-riga-sx">
                        <input type="text" value="<?php echo $this->impostazioni['#beb-eab-banner-testo p']['font-size']; ?>"
                            alt="beb-eab-banner-description-size" name="<?php echo $nome_arr_form; ?>[#beb-eab-banner-testo p][font-size]" />
                    </div>
                    <div class="fmt-eab-riga-dx">
                        ...
                        <?php echo __("right", parent::$prefisso_nome); ?><br />
                ...
                <div class="fmt-eab-riga">
                    <p><?php echo __("Left link:", parent::$prefisso_nome); ?></p>
                    <div class="fmt-eab-riga-sx">
                        <input type="text" value="<?php echo $this->impostazioni['#beb-eab-banner-cont-prenota-sx a']['font-size']; ?>"
                            alt="beb-eab-banner-left-link-size" name="<?php echo $nome_arr_form; ?>[#beb-eab-banner-cont-prenota-sx a][font-size]" />
                    </div>
                    <div class="fmt-eab-riga-dx">
                ...
                <div class="fmt-eab-riga">
                    <p><?php echo __("Right link:", parent::$prefisso_nome); ?></p>
                    <div class="fmt-eab-riga-sx">
                        <input type="text" value="<?php echo $this->impostazioni['#beb-eab-banner-cont-prenota-dx a']['font-size']; ?>"
                            alt="beb-eab-banner-right-link-size" name="<?php echo $nome_arr_form; ?>[#beb-eab-banner-cont-prenota-dx a][font-size]" />
                    </div>
                    <div class="fmt-eab-riga-dx">
        ...
        <div class="beb-eab-contenitore-admin beb-eab-imp-reset">
            <h1 style="margin-bottom: 50px;"><?php echo __("Reset all settings", parent::$prefisso_nome); ?></h1>
            <form method="post" action="options.php">
            <?php settings_fields($nome_arr_form.'_gr'); ?>
                <div class="fmt-eab-riga">
                    <p><?php echo __("By clicking on the button below will restore the factory settings losing custom ones. Are you sure you want to continue?", parent::$prefisso_nome); ?></p>
                </div>
                <div class="fmt-eab-riga-submit">
                <!--
                    <input id="eab-parti-col-reset" type="hidden" value="no" name="<?php echo $nome_arr_form; ?>[reset]" />
                     -->
                    <p class="submit" style="padding: 0 0 0 40%; width: auto;">
                        <input id="submit" type="submit" class="button button-primary eab-reset" value="<?php echo __("Yes, I'm sure, reset !", parent::$prefisso_nome); ?>"
                            name="<?php echo $nome_arr_form; ?>[resetta tutto]" style="padding: 0 10px; width: auto;" />
                    </p>
                    <img class="beb-eab-help-up" src="<?php echo BEBCVBANNER__PLUGIN_URL.'img/up.png';?>" />
                </div>
            </form>
	...
	/*
	 * PAGINA DELLE SOLUZIONI PARZIALI AI PROBLEMI TROVATI
	 */
	public function beb_eab_adm_problemi () {
		$nome = parent::$wp_options_prefisso.'issues';
		register_setting (
			self::$nome_form_issues_tmp.'_gr',      // Option group
			self::$nome_form_issues_tmp,      // Option name
			array ($this, 'beb_eab_adm_sanitize_issues') // Sanitize
		);
	}
	public function beb_eab_adm_problemi_contenuto () {
		$nome = parent::$wp_options_prefisso.'issues';
		$nome_arr_form = self::$nome_form_issues_tmp;?>
		<div class="beb-eab-contenitore-admin indice">
			<h1 style="text-align: center;"><?php echo __("Troubleshooting", parent::$prefisso_nome); ?></h1>
			<h3 style="text-align: center;"><?php echo __('(All the text has been translated with google translator, I apologize for my English)',
					parent::$prefisso_nome); ?></h3>
			<div class="fmt-eab-riga">
                <p><i>
            	<?php echo __("This page has been created temporarily for those problems whose definitive solution has not been found yet. I apologize for the inconvenience, I know that solutions are inelegant, but in this period I'm very busy.",
        			parent::$prefisso_nome); ?></i></p>
                <br />
                <p style="text-align: center; text-decoration: underline;"><i>
            		<?php echo __('I will try to resolve them as soon as possible.', parent::$prefisso_nome); ?></i></p>
                <br />
                <br />
            	<h1><?php echo __('Index', parent::$prefisso_nome); ?></span></h1>
                <ol>
                    <li><span class="beb-eab-banner-indice" title="beb-eab-event-calendar">
                    	<?php echo __('Compatibility issues with "All in one Event Calendar"', parent::$prefisso_nome); ?></span>
                    </li>
                </ol>
            </div>
		</div>
        <div class="beb-eab-contenitore-admin beb-eab-event-calendar">
           	<h1 style="color: #0000ff; padding: 0 5%; text-align: center;"><?php
           		echo __('Compatibility issues with "All in one Event Calendar"', parent::$prefisso_nome); ?></h1>
	        <div class="fmt-eab-riga">
                <div class="fmt-eab-riga-sx">
                    <strong><?php echo __('Error:', parent::$prefisso_nome); ?></strong>
                </div>
                <div class="fmt-eab-riga-dx">
                    <strong><i>
               		<?php echo __('When my plugin is active, the setting page of "All in one event calendar" don\'t display settings option.', parent::$prefisso_nome); ?>
               		</i></strong>
                </div>
            </div>
            <div class="fmt-eab-riga">
                <div class="fmt-eab-riga-sx">
                    <strong><?php echo __('Check:', parent::$prefisso_nome); ?></strong>
                </div>
                <div class="fmt-eab-riga-dx">
                    <p><?php echo __('I looked for the source of this incompatibility and I came to the following conclusion:',
               			parent::$prefisso_nome); ?></p>
                    <ul style="list-style: outside; padding-left: 30px;">
               			<li><?php echo __('They not affected the functionality of "all in one calendar events", is only closed on display',
               					parent::$prefisso_nome); ?> (CSS - display: none;)</li>
               			<li><?php echo __('Not due to css files', parent::$prefisso_nome); ?></li>
               			<li><?php echo __('Not due to js files', parent::$prefisso_nome); ?></li>
               			<li><?php echo __('The problem is that the preview of the banner is loaded regardless of which page you are',
               				parent::$prefisso_nome); ?> (file: beb-events-ads-banner-op-com.php).<br />
               			<?php echo __('Initially this solution I had adopted in order to show the banner in action in the subject, even if logged.',
               				parent::$prefisso_nome); ?>
               			</li>
               		</ul>
                </div>
            </div>
            <div class="fmt-eab-riga">
                <div class="fmt-eab-riga-sx">
                    <strong><?php echo __('Partial solution:', parent::$prefisso_nome); ?></strong>
                </div>
                <div class="fmt-eab-riga-dx">
                    <?php echo __('By checking the box below you disability previewing the banner throughout the site except in the pages of the plugin.',
           				parent::$prefisso_nome); ?><br />
               		<br />
               		<span style="color: #008000;"><strong><?php echo __('Pros', parent::$prefisso_nome); ?></strong></span><br />
               		<span style="margin-left: 30px;"><?php echo __('In this way "All in one calendar events" we see and work, and also my.',
               				parent::$prefisso_nome); ?></span><br />
               		<span style="color: #ff0000;"><strong><?php echo __('Cons', parent::$prefisso_nome); ?></strong></span><br />
               		<span style="margin-left: 30px;"><?php echo __('If logged in you can not see in the banner theme (but it works, simply not loaded to avoid conflicts).',
               				parent::$prefisso_nome); ?></span>
               		<strong><?php echo __('Fix the Problem:', parent::$prefisso_nome); ?></strong>
                </div>
            </div>
            <form method="post" action="options.php" id="beb-eab-banner-issues">
                <?php settings_fields($nome_arr_form.'_gr'); ?>
                <div class="fmt-eab-riga">
                    <p><strong><?php echo __("Off the display of banners from the rest of the site when logged in (theme) and show it only in plugin's pages ?",
        	    		parent::$prefisso_nome); ?></strong></p>
                    <p style="padding-left: 43%;">
	            	    <?php echo __("Yes", parent::$prefisso_nome); ?>
	            	    <input type="radio" name="<?php echo $nome_arr_form; ?>[compatibility_all_in_one_events_calendar]" value="si"
	            	    	style="margin-right: 15px;" <?php if (isset($this->problemini['compatibility_all_in_one_events_calendar']) and
	                    		$this->problemini['compatibility_all_in_one_events_calendar'] == 'si') { echo 'checked="checked"'; } ?>>

            	        <?php echo __("No", parent::$prefisso_nome); ?>
	            	    <input type="radio" name="<?php echo $nome_arr_form; ?>[compatibility_all_in_one_events_calendar]" value="no"
	            	    	<?php if ((isset($this->problemini['compatibility_all_in_one_events_calendar']) and
	                    		$this->problemini['compatibility_all_in_one_events_calendar'] == 'no') or
	            	    		!isset($this->problemini['compatibility_all_in_one_events_calendar'])) { echo 'checked="checked"'; } ?>>
					</p>
                </div>
               	<div class="fmt-eab-riga">
               	    <p class="submit">
	...
	public function beb_eab_adm_sanitize_add ($input) {
	    ...
	    if ((empty($input['titolo']) and empty($input['nome_evento'])) or (empty($input['titolo']) or empty($input['nome_evento']))) {
    	    ...
    	    $wpml = false;
    	    if (is_plugin_active('sitepress-multilingual-cms/sitepress.php') and function_exists('icl_register_string')) {
    	        $wpml = true;
    	    }
    	    $new_input = array();
    	    foreach ($input as $chiave_form => $contenuto) {
    	        if (!empty($contenuto)) {
    	            if (is_numeric ($contenuto)) {
    	                ...
    	                if ($wpml) {
    	                	if (false === array_search($chiave_form, parent::$chiavi_da_escludere_da_traduzione)) {
    	            			icl_register_string(parent::$prefisso_nome, 'EAB - '.$chiave_form, $contenuto);
    	            		}
    	                }
    	            }
    	        }
    	   ...
    	   if (false == get_option(parent::$wp_options_prefisso.'contenuto')) {
    	       if (add_option(parent::$wp_options_prefisso.'contenuto', $new_input_b)) {
    	           $tipo_mess = 'updated';
    	           $messaggio = __('Successfully saved !', parent::$prefisso_nome).' - <a href="?page='.parent::$elenco_pagine['pagina_preview'].'">'.
	   ...
	   self::beb_eab_adm_aggiungi_mess($tipo_mess, $messaggio);
	}
	    ...
	    if (isset($input2['remove_banner']) and $input2['remove_banner'] === 'si') {
	        if (count($this->contenuto) === 1) {
	            ...
	            if (delete_option(parent::$wp_options_prefisso.'contenuto')) {
	                $tipo_mess = 'updated';
	                $messaggio = __('Successfully deleted !', parent::$prefisso_nome).' - <a href="?page='.parent::$elenco_pagine['pagina_add'].'">'.
	...
	public function beb_eab_adm_sanitize_impostazioni ($input3) {
	            ...
	            if (is_array($impostaz_css)) {
	                foreach ($impostaz_css as $tipo => $valore) {
	                    if ($tipo == 'color' or $tipo == 'colore_1' or $tipo == 'colore_2') {
	                    	...
	                    	if ('#beb-eab-banner-cont-prenota-sx a' !== $id_class and '#beb-eab-banner-cont-prenota-dx a' !== $id_class) {
	                    		$input3 [$id_class]['line-height'] = sanitize_text_field($valore);
	                    	}
	                    }
	    ...
	    if (isset($errore['colori']) and isset($errore['numeri']) and isset($errore['opacita'])) {
	        ...
	        if (isset($input3['resetta tutto'])) {
	            if (delete_option(parent::$wp_options_prefisso.'impostazioni')) {
	                $input3 = parent::$impostazioni_iniziali;
	                $impostazioni_originali = false;
	                $tipo_mess = 'updated';
	                $messaggio = __('Old settings are successfully deleted and...', parent::$prefisso_nome);
	            } else {
	                $messaggio = __('Oops there was some error on deleting old settings (01), please try again.', parent::$prefisso_nome);
	            }
	        }
	        ...
	        if ($impostazioni_originali != false) {
	            ...
	            if (update_option(parent::$wp_options_prefisso.'impostazioni', $impostazioni_modifcate)) {
	                $tipo_mess = 'updated';
	                $messaggio = __('Settings are successfully updated !', parent::$prefisso_nome).' - <a href="?page='.parent::$elenco_pagine['pagina_add'].'">'.
	                    __('Create one', parent::$prefisso_nome).'</a>';
	            } else {
	...
	public function beb_eab_adm_sanitize_issues ($input4) {
		$tipo_mess = 'error';
		foreach ($input4 as $chiave => $value) {
			$input4[$chiave] = sanitize_text_field($value);
		}
		global $wpdb;
		if (isset($input4['compatibility_all_in_one_events_calendar'])) {
			$this->problemini['compatibility_all_in_one_events_calendar'] = $input4['compatibility_all_in_one_events_calendar'];
		}

		if (get_option(parent::$wp_options_prefisso.'problemini') === false) {
			if (add_option(parent::$wp_options_prefisso.'problemini', $this->problemini)) {
				$tipo_mess = 'updated';
				$messaggio = __('Successfully added !', parent::$prefisso_nome);
			} else {
				$messaggio = __('Oops there was some error adding, please try again.', parent::$prefisso_nome);
			}
		} else {
			if (update_option(parent::$wp_options_prefisso.'problemini', $this->problemini)) {
				$tipo_mess = 'updated';
				$messaggio = __('Successfully updated !', parent::$prefisso_nome);
			} else {
				$messaggio = __('Oops there was some error updating, please try again.', parent::$prefisso_nome);
